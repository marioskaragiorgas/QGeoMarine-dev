...
class QGeoMarine(QtWidgets.QMainWindow):
    ...
    def __init__(self, project_data):
        ...
        # Initialize handlers
        self.segy_handler = SEISMIC.SEGYHandler(db_file_path=None, bin_file_path=None)
    ...
    def load_segy_file(self, file_path):
        ...
        try:
            self.segy_handler = SEISMIC.SEGYHandler(db_file_path=db_filepath, bin_file_path=bin_filepath)
